...
def parse_args():
    ...
    parser.add_argument("--epochs", default=600, type=int, help="Number of training epochs. Default is 100.")
    ...
    parser.add_argument("--configs_path", default="configs/McPAS.yml", type=str, help="Path to training data file.")
    parser.add_argument("--configs_path2", default="configs/McPAS2.yml", type=str, help="Path to training data file.")
